...
To configure Okta provide following inputs:
	...
	- :guilabel:`Org ExternalKey` : Provide the Org external key from your Okta application configuration in the SAML Issuer ID field. This key is in a format like this example: http://www.okta.com/abcdaxyz, where abcdxyz is the Org ExternalKey.
